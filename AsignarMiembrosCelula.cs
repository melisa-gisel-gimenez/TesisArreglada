...
namespace arreglarTesis
{
    public partial class AsignarMiembrosCelula : Form
    {
        ...
        private void AsignarMiembrosCelula_Load(object sender, EventArgs e)
        {
        ...
        private void buttonListaCelula_Click(object sender, EventArgs e)
        {
            ListaMiembros form1 = new ListaMiembros();  
            form1 = new ListaMiembros();
        }
    }
}
